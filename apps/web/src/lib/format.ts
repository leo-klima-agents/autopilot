 ...
 *  revenueUnit convention: "$" prefix for USD-priced datasets (historical
 *  and the calibrated synthetic archetypes), plain index units otherwise,
 *  every panel must agree on this. */
